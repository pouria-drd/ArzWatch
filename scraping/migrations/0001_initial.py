    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fa_name', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.AddField(
            ...
            name='default_source',
            field=models.ForeignKey(blank=True, help_text='Default source for scraping this instrument.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='instruments_default', to='scraping.sourcemodel'),
        ),
        migrations.CreateModel(
            name='PriceTickModel',
            fields=[
                ...
                ('currency', models.CharField(choices=[('EUR', 'Euro'), ('USD', 'US Dollar'), ('USDT', 'Tether'), ('IRR', 'Iranian Rial')], db_index=True, default='IRR', max_length=5)),
